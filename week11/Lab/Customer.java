public class Customer {
	...
	public void setEmail(String email) {
		...
		String domain = email.substring(at_location + 1, email.length()); //to fix the unknown error for the output i just added + 1 
	...
	/**
	 * Method to compare customer last names
	 * @param customerTwo
	 * @return integer used for ordering
	 * return 1 if "this" last name comes before compared name
	 * return -1 if "this" last name comes alphabetically after compared name
	 */
	public int compareTo(Customer customerTwo){
		String nameOne = this.getName();
		String nameTwo = customerTwo.getName();

		String [] slicedOne = nameOne.split(" ", 2);
		String [] slicedTwo = nameTwo.split(" ", 2);
		String lastNameOne = slicedOne[1];
		String lastNameTwo = slicedTwo[1];
		char nameOneChar = lastNameOne.charAt(0);
		char nameTwoChar = lastNameTwo.charAt(0);
		int nameOneValue = (int) nameOneChar;
		int nameTwoValue = (int) nameTwoChar;
