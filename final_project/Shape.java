...
public abstract class Shape implements Drawable{
  ...
  /**
     * Abstract method to compute the distance from the camera's position to the shape.
     * @param cameraPosition The camera's position as a Point.
     * @return The distance from the camera to the closest point of the shape.
     */
    public abstract double computeDistance(Point cameraPosition);
